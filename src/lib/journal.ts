    ...
    items: [
      {
        ...
        to: "/about",
        description: "Overview, mission, and editorial approach.",
      },
      {
        label: "Aim & Objectives",
        to: "/aims-scope",
        description: "Aim, objectives, and academic focus.",
      },
      { label: "Vision", to: "/vision-mission", description: "Long-term vision of INSIGHTONIX." },
      {
        label: "Mission",
        to: "/vision-mission",
        description: "Mission and editorial commitments.",
      },
      {
        label: "Focus & Scope",
        to: "/aims-scope",
        description: "Subject areas and manuscript types.",
      },
      {
      ...
      },
      {
        ...
        description: "Open access and licensing terms.",
      },
      {
        label: "Publication Charges",
        to: "/apc",
        description: "Publication and processing charges policy.",
      },
      { label: "Journal Information", to: "/about", description: "Journal profile and details." },
      {
        label: "Contact Information",
        to: "/contact",
        description: "Editorial office contact channels.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        to: "/editor-in-chief",
        description: "Leadership and editorial vision.",
      },
      {
        label: "Managing Editor",
        to: "/editorial-office",
        description: "Managing editor and editorial office.",
      },
      {
        label: "Associate Editors",
        to: "/associate-editors",
        description: "Subject-area associate editors.",
      },
      {
        label: "Editorial Board",
        to: "/editorial-board",
        description: "Full editorial board members.",
      },
      { label: "Advisory Board", to: "/advisory-board", description: "Senior academic advisors." },
      {
        label: "Editorial Office",
        to: "/editorial-office",
        description: "Editorial office and coordination.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        to: "/join-reviewer",
        description: "Apply to join the reviewer panel.",
      },
      {
        label: "Reviewer Guidelines",
        to: "/peer-review-policy",
        description: "How reviewers should evaluate work.",
      },
      {
        label: "Reviewer Responsibilities",
        to: "/peer-review-policy",
        description: "Confidentiality, objectivity, timeliness.",
      },
      {
        label: "Review Process",
        to: "/peer-review-policy",
        description: "Double-blind peer review workflow.",
      },
      {
        label: "Reviewer Recognition",
        to: "/reviewers",
        description: "Acknowledgement and reviewer honours.",
      },
      {
        label: "Reviewer Certificate",
        to: "/verify",
        description: "Verifiable reviewer certificates.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Complete instructions for authors.",
      },
      {
        label: "Manuscript Template",
        to: "/manuscript-template",
        description: "Download the official DOCX template.",
      },
      {
        label: "Paper Format",
        to: "/author-guidelines",
        description: "Formatting rules for manuscripts.",
      },
      {
        label: "APA 7 Referencing",
        to: "/author-guidelines",
      ...
      },
      {
        ...
        to: "/author-guidelines",
        description: "Presenting tables and figures.",
      },
      {
      ...
      },
      {
        ...
        to: "/copyright-form",
        description: "Fillable rights-assignment form.",
      },
      {
        label: "Author Declaration",
        to: "/author-declaration-form",
        description: "Originality and disclosure form.",
      },
      {
        label: "AI Policy for Authors",
        to: "/publication-ethics",
        description: "Use of generative AI in manuscripts.",
      },
    ...
    items: [
      {
        label: "Publication Ethics",
        to: "/publication-ethics",
        description: "Overall ethics statement.",
      },
      {
        label: "Author Ethics",
        to: "/publication-ethics",
        description: "Responsibilities of authors.",
      },
      {
        label: "Reviewer Ethics",
        to: "/publication-ethics",
        description: "Responsibilities of reviewers.",
      },
      {
        label: "Editor Ethics",
        to: "/publication-ethics",
        description: "Responsibilities of editors.",
      },
      {
        label: "Publisher Ethics",
        to: "/publication-ethics",
        description: "Responsibilities of the publisher.",
      },
      {
        label: "Conflict of Interest",
        to: "/publication-ethics",
        description: "Declaring competing interests.",
      },
      {
        label: "Plagiarism Policy",
        to: "/plagiarism-policy",
        description: "Plagiarism detection and penalties.",
      },
      {
        label: "AI Policy",
        to: "/publication-ethics",
        description: "Use of AI in the publishing workflow.",
      },
      {
        label: "Retraction Policy",
        to: "/publication-ethics",
        description: "When and how articles are retracted.",
      },
      {
        label: "Corrections Policy",
        to: "/publication-ethics",
        description: "Corrigenda and errata.",
      },
    ],
  },
    ...
    items: [
      {
        label: "Current Issue",
        to: "/current-issue",
        description: "The most recent quarterly issue.",
      },
      { label: "Table of Contents", to: "/current-issue", description: "Full table of contents." },
      {
        label: "Research Articles",
        to: "/latest-articles",
        description: "Original research articles.",
      },
      { label: "Review Articles", to: "/articles", description: "Review articles across issues." },
      {
        label: "Case Studies",
        to: "/articles",
        description: "Case studies published in INSIGHTONIX.",
      },
      {
        label: "Accepted Papers",
        to: "/accepted-papers",
        description: "Articles accepted for publication.",
      },
    ...
    items: [
      {
        label: "By Year",
        to: "/archives/year",
        description: "Browse archives by publication year.",
      },
      {
        label: "By Volume",
        to: "/archives/volume",
        description: "Browse archives by volume number.",
      },
...

  {
    ...
    items: [
      ...
      { label: "Special Issues", to: "/special-issues", description: "Themed and special issues." },
      {
        ...
        to: "/join-reviewer",
        description: "Invitation to join the reviewer panel.",
      },
      {
        label: "Conference Announcements",
        to: "/conferences",
    ...
    items: [
      {
        ...
        to: "/peer-review-policy",
        description: "Editorial office screening.",
      },
      {
        label: "Editorial Review",
        to: "/peer-review-policy",
        description: "Editor-level assessment.",
      },
      {
        label: "Double-Blind Review",
        to: "/peer-review-policy",
        description: "External double-blind evaluation.",
      },
      { label: "Revision", to: "/peer-review-policy", description: "Author revision cycle." },
      {
        label: "Final Decision",
        to: "/peer-review-policy",
        description: "Editor-in-Chief decision.",
      },
      {
        label: "Proofreading",
      ...
      },
      {
        ...
        to: "/doi-information",
        description: "DOI registration and assignment.",
      },
      {
        label: "Publication",
        to: "/publication-process",
        description: "Final publication in INSIGHTONIX.",
      },
    ],
  },
    ...
    items: [
      {
        label: "Contact Us",
        to: "/contact",
        description: "Send a message to the editorial office.",
      },
      {
        label: "Editorial Office",
        to: "/editorial-office",
        description: "Editorial office details.",
      },
      {
        label: "Technical Support",
        to: "/technical-support",
        description: "Platform and submission support.",
      },
