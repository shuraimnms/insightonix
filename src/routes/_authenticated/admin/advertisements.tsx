    ...
    <div>
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Banners shown on the homepage and sidebar. Only active ads within the scheduled window are
          shown publicly.
        </p>
      </header>
            ...
            <div key={r.id} className="rounded-xl border border-border bg-card p-4">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <div className="mt-0.5 text-xs uppercase tracking-widest text-brand font-semibold">
                    {r.placement}
                  </div>
                ...
                <div className="flex flex-none gap-1">
                  <button
                    onClick={() => toggle(r)}
                    className={`inline-flex h-8 items-center rounded-md px-2 text-xs ${r.is_active ? "bg-brand text-brand-foreground" : "border border-border"}`}
                  >
