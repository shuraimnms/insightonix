...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Insightonix Global Insights Journal is an international peer-reviewed open-access multidisciplinary journal dedicated to publishing innovative, high-impact research across science, engineering, technology, medicine, business, education, humanities, social sciences, and environmental studies." },
      { property: "og:title", content: "About INSIGHTONIX" },
      { property: "og:description", content: "Peer-reviewed open-access multidisciplinary journal with external double-blind peer review." },
    ],
...
const FAQS = [
  { q: "Is INSIGHTONIX peer-reviewed?", a: "Yes. Every manuscript is evaluated through an external double-blind peer-review process by subject-matter reviewers." },
  { q: "How often does INSIGHTONIX publish?", a: "INSIGHTONIX normally publishes four regular issues every year — in March, June, September, and December." },
  ...
  { q: "Which subject areas are accepted?", a: "Science, engineering, technology, medicine, business, education, humanities, social sciences, and environmental studies. See Focus & Scope." },
        ...
        <section className="mt-14 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              Manuscripts may be empirical, analytical, conceptual, quantitative, qualitative, or mixed-method, provided they make a meaningful contribution to knowledge, policy, professional practice, education, or socio-economic development.
            </p>
            <p className="mt-3 text-muted-foreground leading-relaxed">
              All manuscripts submitted to INSIGHTONIX are initially screened by the editorial office for relevance, originality, formatting, plagiarism, language quality, ethical compliance, and adherence to journal guidelines. Manuscripts found suitable are evaluated through an external double-blind peer-review process.
            </p>
          </div>
