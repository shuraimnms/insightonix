  ...
  head: () => ({
    meta: [
      { title: "Contact — INSIGHTONIX" },
      {
        name: "description",
        content:
          "Contact the INSIGHTONIX editorial office for submissions, editorial enquiries, reviewer registration, ethics complaints, and technical support.",
      },
      { property: "og:title", content: "Contact — INSIGHTONIX" },
      {
        property: "og:description",
        content: "Editorial office and enquiry channels for INSIGHTONIX.",
      },
    ],
...
const CONTACT_CHANNELS = [
  {
    ...
    body: "For submitting new manuscripts and supporting documents.",
  },
  {
    title: "Editorial Enquiries",
    body: "For manuscript status, editorial screening, revision, acceptance, or publication.",
  },
  {
    title: "Reviewer Enquiries",
    body: "For reviewer registration, review assignments, guidelines, or communication.",
  },
  {
    title: "Ethics & Complaints",
    body: "For plagiarism complaints, authorship issues, conflicts of interest, corrections, withdrawals, or retractions.",
  },
  {
    title: "Technical Assistance",
    body: "For website registration, login, file upload, or submission-system difficulties.",
  },
];
          ...
          <div>
            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                setTimeout(() => {
                  setBusy(false);
                  toast.success(
                    "Message sent to the editorial office. We usually reply within 2 working days.",
                  );
            ...
            >
              ...
              <label className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <span>
                  I consent to INSIGHTONIX storing the information above solely to respond to my
                  enquiry.
                </span>
              </label>
              <button
                disabled={busy}
                type="submit"
                className="inline-flex h-11 items-center rounded-md bg-brand px-5 text-sm font-semibold text-brand-foreground disabled:opacity-60"
              >
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-border bg-card p-6 text-sm">
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <a href={`mailto:${JOURNAL.email}`} className="hover:text-brand">
                    {JOURNAL.email}
                  </a>
                </div>
                <div className="flex items-start gap-3">
                  <Globe className="mt-0.5 h-4 w-4 text-brand" />
                  <span>insightonix.com</span>
                </div>
                <div className="flex items-start gap-3">
              ...
              <p className="mt-4 text-xs text-muted-foreground">
                Publisher, postal address, telephone, and office hours will be updated once
                officially confirmed by the journal administration.
              </p>
            </div>
            <div className="rounded-2xl border border-amber-400/40 bg-amber-50/40 p-6 text-sm dark:bg-amber-950/20">
              ...
              <p className="mt-2 text-muted-foreground">
                Authors should communicate only through the journal's official email address.
                Manuscript acceptance, publication charges, and payment instructions should be
                treated as valid only when issued through an authorized journal communication
                channel.
              </p>
            </div>
          </aside>
